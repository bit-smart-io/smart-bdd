...
class TestSuiteClassTest {
    ...
    void setsFullyQualifiedName() {
        assertThat(testSuiteClass.getFullyQualifiedName()).isEqualTo("io.bitsmart.bdd.report.junit5.results.model.TestSuiteClassTest");
    }
    ...
    void setsPackageName() {
        assertThat(testSuiteClass.getPackageName()).isEqualTo("io.bitsmart.bdd.report.junit5.results.model");
    }
}